 ...
 * Rota raiz do site.
 *
 * Quando alguém acessa o endereço base do projeto,
 * o sistema redireciona direto para a tela de entrada. Não existe
 * página inicial pública porque o SupportBox é local ainda.
 *
 ...
 * o painel certo (solicitante/agente), caso ele já esteja entrado. Por enquanto, manda
